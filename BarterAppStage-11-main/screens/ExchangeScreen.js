...
export default class ExchangeScreen extends Component{
  ...
  getData(){
    fetch("http://data.fixer.io/api/latest?access_key=cf3b06d31d5e5724c5aafdde08fd616e")
    .then(response=>{
    ...
    if(this.state.isItemRequestActive === true){
      return(
        <View style = {{flex : 1, justifyContent : 'center'}}>
          ...
          <TouchableOpacity
            style = {{borderWidth : 1, borderColor : 'orange', backgroundColor : 'orange', width : 300, alignItems : 'center', alignSelf : 'center', height : 30, marginTop : 30}}
            onPress = {()=>{
